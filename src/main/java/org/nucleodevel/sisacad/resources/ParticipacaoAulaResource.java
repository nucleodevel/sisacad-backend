...
public class ParticipacaoAulaResource
	...
	public ResponseEntity<ParticipacaoAulaDto> find(@PathVariable Integer id) {
		return super.find(id);
	}

	@RequestMapping(method = RequestMethod.POST)
	public ResponseEntity<ParticipacaoAulaDto> insert(@RequestBody ParticipacaoAulaDto dto) {
		return super.insert(dto);
	}

	@RequestMapping(value = "/{id}", method = RequestMethod.PUT)
	public ResponseEntity<Void> update(@RequestBody ParticipacaoAulaDto dto, @PathVariable Integer id) {
	...
	public ResponseEntity<List<ParticipacaoAulaDto>> findAll() {
