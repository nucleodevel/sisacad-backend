...
public class DocenteResource extends AbstractResource<Docente, DocenteDto, Integer, DocenteService> {
	...
	public ResponseEntity<DocenteDto> find(@PathVariable Integer id) {
		return super.find(id);
	}

	@RequestMapping(method = RequestMethod.POST)
	public ResponseEntity<DocenteDto> insert(@RequestBody DocenteDto dto) {
		return super.insert(dto);
	}

	@RequestMapping(value = "/{id}", method = RequestMethod.PUT)
	public ResponseEntity<Void> update(@RequestBody DocenteDto dto, @PathVariable Integer id) {
